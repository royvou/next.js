...
const nextConfigIsrMemoryZero = `module.exports = {
  experimental: {
    isrMemoryCacheSize: 0,
  }
}`

const nextConfigDefault = `module.exports = {}`
...
createNextDescribe(
  ...
  ({ next }) => {
    it.each([nextConfigDefault, nextConfigIsrMemoryZero])(
      'should revalidate after notFound is returned for fallback: blocking and the page was previously generated %s',
      async (nextConfig) => {
